        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -top-8 -right-8 w-24 h-24 bg-yellow-300 rounded-full flex items-center justify-center shadow-lg z-20"
            >
          ...
          >
            ...
            <div className="mt-4">
              <button className="px-8 py-4 rounded-full bg-cyan-400 text-fuchsia-900 font-bold text-lg shadow-xl hover:bg-cyan-300 hover:scale-105 transition-all duration-300">
                Read Our Story
              </button>
            </div>
          </motion.div>
