...
export default function ProductCard({ id, name, price, image, rating, stock, delay }) {
  ...
  return (
    ...
    >
      ...
      <Link to={`/product/${id}`} className="w-full relative">
      ...
      <div className="text-center z-10 w-full">
        ...
        <p className="text-2xl font-black text-fuchsia-500 mb-6 italic">
          <span className="text-sm mr-1">$</span>{price.replace('$', '')}
        </p>
